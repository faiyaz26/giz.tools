    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="mb-16">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white">Popular Tools</h2>
            ...
            return (
              ...
              >
                ...
                <CardHeader className="relative">
                  ...
                  <CardDescription className="text-base dark:text-gray-300">{tool.description}</CardDescription>
                </CardHeader>
