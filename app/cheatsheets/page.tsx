      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed">
            ...
            Find syntax, examples, and best practices all in one place.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          {cheatsheets.map((cheatsheet) => (
            ...
            >
              <div className={`absolute inset-0 bg-gradient-to-br opacity-5 group-hover:opacity-10 transition-opacity ${cheatsheet.color}`}></div>
              
              <CardHeader>
                <div className="flex items-center justify-between mb-2">
                  <div className={`p-3 rounded-xl bg-gradient-to-br ${cheatsheet.color}`}>
                    <cheatsheet.icon className="h-6 w-6 text-white" />
                  </div>
                  <Badge className={cheatsheet.badge === "Coming Soon" ? "bg-amber-600" : "bg-green-600"}>
                    {cheatsheet.badge}
                  </Badge>
                </div>
                <CardTitle className="text-2xl text-slate-100">{cheatsheet.title}</CardTitle>
                <CardDescription className="text-slate-300">{cheatsheet.description}</CardDescription>
              </CardHeader>
              
              <CardContent>
                <div className="mb-6">
                  <h4 className="text-sm font-medium text-slate-400 mb-2">Includes:</h4>
        ...
        <div className="text-center bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-12 text-white">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Check out our collection of articles and guides for in-depth learning.
          </p>
